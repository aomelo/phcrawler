...
#train_filename = "../tensorflow/tensorflow/examples/udacity/notMNIST_large"
#test_filename = "../tensorflow/tensorflow/examples/udacity/notMNIST_large"
train_filename = "../crawlspider/data"
test_filename  = "../crawlspider/data"
...
def load_letter(folder, min_num_images):
  ...
  for image in os.listdir(folder):
    ...
    try:
      ...
      image_grey = np.ndarray((image_data.shape[0],image_data.shape[1]))
      for x in range(image_grey.shape[0]):
        for y in range(image_grey.shape[1]):
          image_grey[x,y] = np.mean(image_data[x,y,])
...
datasets = maybe_pickle(train_folders, 0)
...
def load_datasets(pickle_files, train_size, valid_size=0, test_size=0):
  num_classes = len(pickle_files)
  valid_dataset, valid_labels = make_arrays(valid_size, image_height, image_width)
